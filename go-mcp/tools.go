...
type Args struct {
	Entity string         `json:"entity" jsonschema:"check_profanity"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ProfanityCheckerSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "profanity-checker_list",
		Description: "List records from ProfanityChecker. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "profanity-checker_load",
		Description: "Load a single record from ProfanityChecker. " +
...
func runOp(client *sdk.ProfanityCheckerSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ProfanityCheckerSDK, name string) (sdk.ProfanityCheckerEntity, error) {
	switch strings.ToLower(name) {
	case "check_profanity":
		return client.CheckProfanity(nil), nil
