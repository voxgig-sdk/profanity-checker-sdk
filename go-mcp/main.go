// Command ProfanityChecker-mcp is an MCP server exposing the ProfanityChecker
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ProfanityChecker_list  — list records of an entity
//	ProfanityChecker_load  — load a single record of an entity
//
