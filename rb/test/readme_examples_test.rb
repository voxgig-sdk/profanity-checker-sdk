...
#      offline in seeded test mode (ProfanityCheckerSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ProfanityChecker_sdk.rb")
  SDK_CLASS = "ProfanityCheckerSDK"
