...
The Python SDK for the ProfanityChecker API. Provides an entity-oriented interface following Pythonic conventions.
...
```python
# Create
created, _ = client.CheckProfanity(None).create({"name": "Example"}, None)
...
result, err = client.ProfanityChecker(None).load(
    {"id": "test01"}, None
)
