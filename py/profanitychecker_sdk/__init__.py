...
from profanitychecker_sdk.utility import register

# Load features
from profanitychecker_sdk.feature.base_feature import ProfanityCheckerBaseFeature
from profanitychecker_sdk.features import _has_feature, _make_feature
...
class ProfanityCheckerSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ProfanityCheckerUtility()
        self._utility = utility

        from profanitychecker_sdk.config import shared_config
    ...
    def get_utility(self):
        return ProfanityCheckerUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ProfanityCheckerSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def CheckProfanity(self, data=None) -> "CheckProfanityEntity":
        ...
        from profanitychecker_sdk.entity.check_profanity_entity import CheckProfanityEntity
