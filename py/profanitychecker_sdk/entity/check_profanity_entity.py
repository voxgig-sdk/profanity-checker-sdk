...
from profanitychecker_sdk.profanitychecker_types import (
    CheckProfanity,
...
class CheckProfanityEntity:
    ...
    def data_get(self) -> CheckProfanity:
    ...
    def match_get(self) -> CheckProfanity:
    ...
    def create(self, reqdata: CheckProfanityCreateData, ctrl=None) -> CheckProfanity:
        utility = self._utility
