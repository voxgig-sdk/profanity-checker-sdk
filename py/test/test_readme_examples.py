# ProfanityChecker SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ProfanityCheckerSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ProfanityCheckerSDK(...) and ProfanityCheckerSDK.test(...) become
#      ProfanityCheckerSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "profanitychecker_sdk"
_SDK_CLASS = "ProfanityCheckerSDK"
...
_ENTITIES = {
    "CheckProfanity": "check_profanity",
}
