...
class ProfanityCheckerTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ProfanityCheckerTestRunner.getenv("PROFANITY_CHECKER_TEST_LIVE")
        override = ProfanityCheckerTestRunner.getenv("PROFANITY_CHECKER_TEST_OVERRIDE")
        ...
        explain = ProfanityCheckerTestRunner.getenv("PROFANITY_CHECKER_TEST_EXPLAIN")
...
def entity_data(v):
    return ProfanityCheckerTestRunner.entity_data(v)
...
def live_client_options():
    return ProfanityCheckerTestRunner.live_client_options()
