...
|---|---|---|
| `ts/` | @voxgig-sdk/profanity-checker-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/profanity-checker-sdk \
      --repository voxgig-sdk/profanity-checker-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/profanity-checker-sdk` shows it, and
`npm trust revoke @voxgig-sdk/profanity-checker-sdk --id=<id>` removes it.
