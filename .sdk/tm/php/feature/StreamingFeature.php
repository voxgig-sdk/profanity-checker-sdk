...
// ProfanityChecker SDK streaming feature
...
class ProfanityCheckerStreamingFeature extends ProfanityCheckerBaseFeature
{
    ...
    private function _iterate(ProfanityCheckerResult $result): \Generator
    {
    ...
    private function _streamable(ProfanityCheckerContext $ctx): bool
    {
