...
// ProfanityChecker SDK idempotency feature
...
class ProfanityCheckerIdempotencyFeature extends ProfanityCheckerBaseFeature
{
    ...
    private function _mutating(ProfanityCheckerContext $ctx): bool
    {
