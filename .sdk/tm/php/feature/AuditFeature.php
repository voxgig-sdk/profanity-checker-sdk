...
// ProfanityChecker SDK audit feature
...
class ProfanityCheckerAuditFeature extends ProfanityCheckerBaseFeature
{
    ...
    private function _emit(ProfanityCheckerContext $ctx, string $outcome): void
    {
