...
// ProfanityChecker SDK rbac feature
...
class ProfanityCheckerRbacFeature extends ProfanityCheckerBaseFeature
{
    ...
    private function _required(ProfanityCheckerContext $ctx): ?string
    {
    ...
    private function _reject(ProfanityCheckerContext $ctx, string $required): void
    {
    ...
    private function _track(ProfanityCheckerContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
