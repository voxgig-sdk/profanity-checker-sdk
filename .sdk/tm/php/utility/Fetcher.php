...
// ProfanityChecker SDK utility: fetcher

class ProfanityCheckerFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ProfanityCheckerSDK/1.0)';
    ...
    public static function call(ProfanityCheckerContext $ctx, string $fullurl, array $fetchdef): array
    {
