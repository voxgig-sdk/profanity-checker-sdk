...
// ProfanityChecker SDK utility: make_options

class ProfanityCheckerMakeOptions
{
    ...
    public static function call(ProfanityCheckerContext $ctx): array
    {
        ...
        //
        // `ProfanityCheckerSchema::optspec()` is built from the model:
        ...
        $optspec = ProfanityCheckerSchema::optspec();
