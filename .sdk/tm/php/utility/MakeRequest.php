...
// ProfanityChecker SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ProfanityCheckerMakeRequest
{
    public static function call(ProfanityCheckerContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ProfanityCheckerResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ProfanityCheckerResponse($fetched);
        } else {
