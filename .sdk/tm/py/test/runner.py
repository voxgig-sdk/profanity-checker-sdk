...
class ProfanityCheckerTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ProfanityCheckerTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ProfanityCheckerTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ProfanityCheckerTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
