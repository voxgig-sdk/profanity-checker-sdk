...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/profanity-checker` | `npm install @voxgig-sdk/profanity-checker` |
| Python | `voxgig-sdk-profanity-checker` | `pip install voxgig-sdk-profanity-checker` |
| PHP | `voxgig-sdk/profanity-checker` | `composer require voxgig-sdk/profanity-checker` |
| Golang | `github.com/voxgig-sdk/profanity-checker-sdk/go` | `go get github.com/voxgig-sdk/profanity-checker-sdk/go` |
| Ruby | `voxgig-sdk-profanity-checker` | `gem install voxgig-sdk-profanity-checker` |
| Lua | `voxgig-sdk-profanity-checker` | `luarocks install voxgig-sdk-profanity-checker` |
