...
// instead of `sdk.NewProfanityCheckerSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *ProfanityCheckerSDK  { return NewProfanityCheckerSDK(nil) }
func Test() *ProfanityCheckerSDK { return TestSDK(nil, nil) }
