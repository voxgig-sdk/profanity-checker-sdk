...
type ProfanityCheckerSDK struct {
	Mode     string
...
func (sdk *ProfanityCheckerSDK) OptionsMap() map[string]any {
...
func (sdk *ProfanityCheckerSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ProfanityCheckerSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ProfanityCheckerSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ProfanityCheckerSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ProfanityCheckerSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ProfanityCheckerSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ProfanityCheckerSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ProfanityCheckerSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ProfanityCheckerSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ProfanityCheckerSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ProfanityCheckerSDK {
	...
	sdk := NewProfanityCheckerSDK(sdkopts)
	sdk.Mode = "test"
