...
type CheckProfanityEntity struct {
	name    string
	client  *core.ProfanityCheckerSDK
...
func NewCheckProfanityEntity(client *core.ProfanityCheckerSDK, entopts map[string]any) *CheckProfanityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CheckProfanityEntity) GetName() string { return e.name }
...
func (e *CheckProfanityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CheckProfanityEntity) Deleted() bool {
	return e.deleted
}


func (e *CheckProfanityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCheckProfanityEntity(e.client, opts)
}

func (e *CheckProfanityEntity) Data(args ...any) any {
...
func (e *CheckProfanityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CheckProfanity; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CheckProfanityEntity) DataTyped(data ...CheckProfanity) CheckProfanity {
	if len(data) > 0 {
		return typedFrom[CheckProfanity](e.Data(asMap(data[0])))
	}
	return typedFrom[CheckProfanity](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CheckProfanity (all fields
// optional at the wire level).
func (e *CheckProfanityEntity) MatchTyped(match ...CheckProfanity) CheckProfanity {
	if len(match) > 0 {
		return typedFrom[CheckProfanity](e.Match(asMap(match[0])))
	}
	return typedFrom[CheckProfanity](e.Match())
}
...
func (e *CheckProfanityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CheckProfanityEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CheckProfanityEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CheckProfanityEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CheckProfanityCreateData and returns an CheckProfanity. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CheckProfanityEntity) CreateTyped(reqdata CheckProfanityCreateData, ctrl map[string]any) (CheckProfanity, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return CheckProfanity{}, err
	}
	return typedFrom[CheckProfanity](res), nil
}



func (e *CheckProfanityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CheckProfanityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CheckProfanityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
