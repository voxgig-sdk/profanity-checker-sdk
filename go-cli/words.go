...
func registerSDKWords(r *eng.Registry, client *sdk.ProfanityCheckerSDK) {
...
func runOp(client *sdk.ProfanityCheckerSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
