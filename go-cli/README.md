...
AQL-driven CLI and REPL for the ProfanityChecker SDK. Positional arguments are
...
```sh
go build -o profanity-checker-cli ./...
```
...
./profanity-checker-cli list check_profanity
./profanity-checker-cli load 1 check_profanity
./profanity-checker-cli load '{id:1}' check_profanity
