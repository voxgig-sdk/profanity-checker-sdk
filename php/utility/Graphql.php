...
// ProfanityChecker SDK utility: graphql
//
...
class ProfanityCheckerGraphql
{
    ...
    // equivalent.
    public static function body(ProfanityCheckerContext $ctx): mixed
    {
    ...
    public static function errors(ProfanityCheckerContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
