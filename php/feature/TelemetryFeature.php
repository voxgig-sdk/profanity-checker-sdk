...
// ProfanityChecker SDK telemetry feature
...
class ProfanityCheckerTelemetryFeature extends ProfanityCheckerBaseFeature
{
    ...
    private function _close(ProfanityCheckerContext $ctx, bool $ok): void
    {
