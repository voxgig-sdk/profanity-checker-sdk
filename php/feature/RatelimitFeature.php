...
// ProfanityChecker SDK ratelimit feature
...
class ProfanityCheckerRatelimitFeature extends ProfanityCheckerBaseFeature
{
    ...
    private function _acquire(ProfanityCheckerContext $ctx): void
    {
    ...
    private function _track(ProfanityCheckerContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
