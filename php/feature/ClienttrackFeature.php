...
// ProfanityChecker SDK clienttrack feature
...
class ProfanityCheckerClienttrackFeature extends ProfanityCheckerBaseFeature
{
    ...
    public function PostConstruct(ProfanityCheckerContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ProfanityChecker-SDK';
