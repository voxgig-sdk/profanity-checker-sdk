...
// ProfanityChecker SDK paging feature
...
class ProfanityCheckerPagingFeature extends ProfanityCheckerBaseFeature
{
    ...
    private function _is_list(ProfanityCheckerContext $ctx): bool
    {
