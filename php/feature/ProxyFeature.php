...
// ProfanityChecker SDK proxy feature
...
class ProfanityCheckerProxyFeature extends ProfanityCheckerBaseFeature
{
    ...
    public function init(ProfanityCheckerContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ProfanityCheckerContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
