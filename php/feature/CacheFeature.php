...
// ProfanityChecker SDK cache feature
...
class ProfanityCheckerCacheFeature extends ProfanityCheckerBaseFeature
{
    ...
    private function _through(ProfanityCheckerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
