...
// ProfanityChecker SDK timeout feature
...
class ProfanityCheckerTimeoutFeature extends ProfanityCheckerBaseFeature
{
    ...
    private function _with_timeout(ProfanityCheckerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ProfanityCheckerContext $_ctx, float $ms): void
    {
        $client = $this->client;
