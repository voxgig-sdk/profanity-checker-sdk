...
// ProfanityChecker SDK netsim feature
...
class ProfanityCheckerNetsimFeature extends ProfanityCheckerBaseFeature
{
    ...
    private function _simulate(ProfanityCheckerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ProfanityCheckerContext $ctx, array $applied): void
    {
        $client = $this->client;
