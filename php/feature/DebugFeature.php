...
// ProfanityChecker SDK debug feature
...
class ProfanityCheckerDebugFeature extends ProfanityCheckerBaseFeature
{
    ...
    private function _finish(ProfanityCheckerContext $ctx, bool $ok): void
    {
