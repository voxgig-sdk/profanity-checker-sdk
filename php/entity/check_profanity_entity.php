...
class CheckProfanityEntity
{
    ...
    /**
     * @param CheckProfanity|array $args CheckProfanity data (assoc-array) to store.
     */
    ...
    /**
     * @return CheckProfanity|array The current CheckProfanity data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CheckProfanity fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CheckProfanity fields).
     */
     ...
     *
     * @param CheckProfanityCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CheckProfanityCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CheckProfanity|array The created CheckProfanity as an assoc-array at the
     *   SDK boundary; throws ProfanityCheckerError on failure (item-5 convention).
     */
