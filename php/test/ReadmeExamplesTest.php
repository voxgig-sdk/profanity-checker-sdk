...
// ProfanityChecker SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ProfanityCheckerSDK::test)
...
{
    private const SDK_CLASS = 'ProfanityCheckerSDK';
    ...
    private const SDK_BASE = 'profanitychecker_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../profanitychecker_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
