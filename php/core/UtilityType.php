...
// ProfanityChecker SDK utility type

class ProfanityCheckerUtility
{
    ...
    public static function copy(ProfanityCheckerUtility $src): ProfanityCheckerUtility
    {
        $u = new ProfanityCheckerUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
