...
function runner.env_override(m)
  local live = runner.getenv("PROFANITYCHECKER_TEST_LIVE")
  local override = runner.getenv("PROFANITYCHECKER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PROFANITYCHECKER_TEST_EXPLAIN")
